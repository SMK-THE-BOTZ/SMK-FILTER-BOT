...
URL = "https://autofilter-bot0.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilter-bot0.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilter-bot0.onrender.com/".format(FQDN)
else:
    URL = "https://autofilter-bot0.onrender.com/".format(FQDN)
